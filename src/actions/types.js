...
// fake timer for one store loading
export const SELLERS_FETCH_BESTSTORE_END = 'SELLERS_FETCH_BESTSTORE_END';
export const SELLERS_FETCH_BESTPRICES_END = 'SELLERS_FETCH_BESTPRICES_END';
