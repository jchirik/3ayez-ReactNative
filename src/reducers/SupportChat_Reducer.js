...
export default (state = INITIAL_STATE, action) => {
  ...
  switch (action.type) {
    ...
    case VALIDATE_SUPPORT_MESSAGE:
      ...
      to_be_validated[to_be_validated_index] = {
        ...to_be_validated[to_be_validated_index],
        received: true,
        sent: true,
        image: uri
      };
      to_be_validated.remove;
      return {
        ...state,
        support_messages_for_group: [].concat(to_be_validated)
      };
